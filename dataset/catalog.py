...
class DatasetCatalog:
    def __init__(self, ROOT):
        ...
        self.COCO2017Keypoint = {
            "target": "dataset.dataset_layout.LayoutDataset",
            "train_params": dict(
                image_root=os.path.join(ROOT, 'coco/images/train2017'),
                layout_json_path=os.path.join(ROOT, 'coco/annotations/instances_train2017.json'),
                caption_json_path=os.path.join(ROOT, 'coco/annotations/captions_train2017.json'),
        ),
        }
        ...
        self.COCO2014Layout = {
            "target": "dataset.dataset_layout.LayoutDataset",
            "train_params": dict(
                image_root=os.path.join(ROOT, 'coco/images/train2014'),
                layout_json_path=os.path.join(ROOT, 'coco/annotations/instances_train2014.json'),
                caption_json_path=os.path.join(ROOT, 'coco/annotations/captions_train2014.json'),
        ),
        }
