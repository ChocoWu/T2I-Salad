...
def to_valid_bbox(x, y, w, h, trans_info, image_size, min_box_size):
    """
    ...
    if x0 > image_size or y0 > image_size or x1 < 0 or y1 < 0 or image_size < x1 or image_size < y1 or x0 > x1 or y0 > y1 :
        valid = False  # no way to make this box vide, it is completely cropped out
        return valid, (None, None, None, None)
