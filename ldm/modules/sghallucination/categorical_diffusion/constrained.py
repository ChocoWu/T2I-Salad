...
class ConstrainedMaskAndReplaceDiffusion(BaseMaskAndReplaceDiffusion):
    ...
    def forward(
        ...
        log_x0_recon = self.predict_start(log_x_t_full, t=t, text_prompt=text_prompt, text_prompt_mask=text_prompt_mask)  # P_theta(x0|xt)
